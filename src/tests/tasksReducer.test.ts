...
import {v1} from "uuid";
import {addTodolistAC, removeTodolistAC} from "../reducers/todolistsReducer";
...
test("new array should be added when new todolist is added", () => {
   ...
   const endState = tasksReducer(startState, addTodolistAC(newTodoId));
